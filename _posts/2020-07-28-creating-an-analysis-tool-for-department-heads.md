...
description: "In my school, we use a tool called \"Canvas\" to manage the homework, tests, lessons, etc. in school. Canvas is open-sourced (all the code is on GitHub), so editing the code is quite easy. However,…"
date: 2020-07-28 11:18:00 +0000
image: /assets/posts/creating-an-analysis-tool-for-department-heads/feature.jpg
tags: ["Projects"]
permalink: "/creating-an-analysis-tool-for-department-heads/"
original_url: "https://www.orimarash.com/creating-an-analysis-tool-for-department-heads/"
---

In my school, we use a tool called ["Canvas"](https://www.instructure.com/canvas/en-gb) to manage the homework,  
...
package ([canvas-api-helper](https://github.com/kingalfred/canvas-api-helper)) which lets you easily query the  
Canvas API.
...
To host this system, I uploaded the entire project to [Firebase](https://firebase.google.com/). Firebase has  
